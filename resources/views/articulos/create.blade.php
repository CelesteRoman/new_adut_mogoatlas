                    ...
                    <div class="x_content">
                        <form method="POST" action="{{ route('articulos.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="Titulo" class="form-control" id="Titulo" placeholder="Título del Artículo">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="ruta_ubicacion">Archivo del Artículo:</label>
                                <input type="file" name="ruta_ubicacion" class="form-control-file" id="ruta_ubicacion">
                            </div>
                            <div class="form-group">
                                <label for="ruta_portada">Imagen del Artículo:</label>
