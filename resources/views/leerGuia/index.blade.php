...
<div  id="pdf-container">
        ...
        <iframe src="{{asset('archivos/3/Guia _de_desarrollo_de_contenido_tematico_Unidad 2_Parcia_ 2_Taller_III_3_2023.pdf')}}"  width="100%" height="750px"></iframe>  
