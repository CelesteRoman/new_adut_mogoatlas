...
<div  id="pdf-container">
        ...
        <iframe src="{{asset('archivos/2/Educacion_en_gastronomia_su_vinculo_con_la_identidad_cultural_y_el_turismo.pdf')}}"  width="100%" height="750px"></iframe>  
